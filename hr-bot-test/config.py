...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgresql://admin:testpassword@10.128.0.79:5469/postgres")
...
WEB_APP_URL = os.environ.get("WEB_APP_URL", "10.128.0.79:5065")
